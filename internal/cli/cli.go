...
type Globals struct {
	ConfigFile string `help:"Config file path" short:"c" env:"ups_CONFIG"`
	APIURL     string `help:"API base URL" env:"ups_API_URL"`
	Timeout    int    `help:"Request timeout in seconds" default:"30" env:"ups_TIMEOUT"`
	NoCache    bool   `help:"Disable caching" env:"ups_NO_CACHE"`
	CacheDir   string `help:"Cache directory" env:"ups_CACHE_DIR"`
	CacheTTL   int    `help:"Cache TTL in minutes" default:"60" env:"ups_CACHE_TTL"`
	Verbose    bool   `help:"Enable verbose output" short:"v" env:"ups_VERBOSE"`
	Debug      bool   `help:"Enable debug output" env:"ups_DEBUG"`
	Format     string `help:"Output format: table, json, markdown" default:"table" enum:"table,json,markdown" env:"ups_FORMAT"`
